...
export default function UserProfile() {
  ...
  const avatarUrl = displayUser.photo_url || `https://ui-avatars.com/api/?name=${encodeURIComponent(displayUser.first_name + (displayUser.last_name || ''))}&background=4fa9ff&color=fff&size=128`
    ...
    >
      <div className="flex items-center space-x-4">
        ...
        <div className="relative">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-sky-400 to-blue-600 flex items-center justify-center overflow-hidden profile-avatar-3d">
          ...
          <div className="absolute -bottom-1 -right-1 w-5 h-5 bg-sky-400 rounded-full border-2 border-gray-900"></div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center space-x-4 mt-2">
            <div className="text-xs">
              ...
              <span className="text-sky-300 font-semibold">{stats.totalDeposits}</span>
            </div>
            <div className="text-xs">
