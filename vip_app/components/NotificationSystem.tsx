    ...
    <>
      ...
      >
        ...
        >
          ...
          {unreadCount > 0 && (
            <span className="absolute -top-0.5 -right-0.5 bg-sky-500 text-white text-[9px] font-bold rounded-full w-3.5 h-3.5 flex items-center justify-center leading-none">
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            {unreadCount > 0 && (
              <button
                ...
                className="text-sky-300 text-xs hover:text-sky-300"
              >
                Прочитать все
              </button>
            )}
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-1.5 mb-0.5">
                        <div className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${
                          notification.type === 'success' ? 'bg-sky-500' :
                        ...
                        <div className="mt-1.5 pt-1.5 border-t border-white/10">
                          <div className="flex items-center justify-between text-[10px]">
                            ...
                            <span className={`font-semibold ${
                              notification.transaction.type === 'deposit' ? 'text-sky-300' : 'text-red-400'
                            }`}>
                    ...
                    <div className="flex gap-1 ml-1 flex-shrink-0">
                      {!notification.read && (
                        <button
                          ...
                          className="text-sky-300 hover:text-sky-300 text-xs w-4 h-4 flex items-center justify-center"
                          title="Прочитано"
                        >
                          ✓
                        </button>
