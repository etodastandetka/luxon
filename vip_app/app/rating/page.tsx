  ...
  return (
    <main className="space-y-6" style={{ paddingBottom: '20px' }}>
      ...
      {progressInfo && progressInfo.nextRank !== progressInfo.currentRank && (
        <div className="card p-4 bg-gradient-to-r from-sky-500/20 to-blue-500/20 border-sky-500/50">
          <div className="mb-3">
            ...
            {friends.map((friend) => (
              <div
                ...
                className={`p-3 rounded-lg ${
                  friend.isAhead ? 'bg-sky-500/10 border border-sky-500/30' : 'bg-blue-500/10 border border-blue-500/30'
                }`}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <span className={friend.isAhead ? 'text-sky-300' : 'text-blue-400'}>
                      {friend.isAhead ? '⬆️' : '⬇️'}
                    </span>
                    <div>
                  ...
                  <div className="text-right">
                    <div className={`text-sm font-bold ${friend.isAhead ? 'text-sky-300' : 'text-blue-400'}`}>
