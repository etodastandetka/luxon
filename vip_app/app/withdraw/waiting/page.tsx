      ...
      {status === 'success' && (
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center space-y-3 max-w-md">
            ...
            <div className="w-16 h-16 mx-auto bg-sky-500 rounded-full flex items-center justify-center">
            ...
            <div className="space-y-1">
              <h1 className="text-xl font-bold text-sky-300">{t.success}</h1>
              <p className="text-white text-sm">{t.successMessage}</p>
            </div>

            <button
              onClick={() => router.push('/')}
              className="px-6 py-2 bg-sky-500 text-white rounded-lg font-semibold hover:bg-sky-600 transition-colors text-sm"
            >
              {t.backHome}
            </button>
          </div>
            ...
            <div className="space-y-2">
              ...
              {requestAmount && (
                <div className="bg-black/40 backdrop-blur rounded-lg p-2 border border-white/20">
                  ...
                  <p className="text-white text-sm">Сумма: <span className="font-bold text-sky-300">{requestAmount} сом</span></p>
                </div>
              )}
              ...
              <div className="bg-black/40 backdrop-blur rounded-lg p-2 border border-white/20 text-left">
                ...
                <div className="space-y-1.5">
                  <div className="text-xs">
                    <p className="text-sky-300 font-medium">• {t.faq1}</p>
                    <p className="text-white/50 text-[10px] leading-tight">{t.faq1Desc}</p>
                  </div>
                  <div className="text-xs">
                    <p className="text-sky-300 font-medium">• {t.faq2}</p>
                    <p className="text-white/50 text-[10px] leading-tight">{t.faq2Desc}</p>
                  </div>
                  <div className="text-xs">
                    <p className="text-sky-300 font-medium">• {t.faq3}</p>
              ...
              <div className="pt-1">
                <button
                  onClick={() => router.push('/')}
                  className="w-full px-4 py-2 bg-sky-500 text-white rounded-lg font-semibold hover:bg-sky-600 transition-colors text-sm"
                >
                  {t.backHome}
                </button>
              </div>
