      ...
      <main className="space-y-6">
        ...
        <div className="card space-y-3">
          ...
          <div className="text-center">
            <a 
              href="/" 
              className="inline-flex items-center gap-2 bg-sky-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-sky-600 transition-colors"
            >
              Авторизоваться
            </a>
          </div>
                  ...
                  <div className="relative max-w-[80%] sm:max-w-[70%] md:max-w-md">
                    <div
                      className={`px-4 py-2.5 rounded-2xl shadow-lg transition-all duration-200 ${
                        isOutgoing
                          ? 'bg-gradient-to-br from-sky-500 to-blue-600 text-black shadow-sky-500/30'
                    ...
                    >
                      ...
                      {editingMessageId === message.id ? (
                        <input
                          ...
                          className="w-full bg-white/10 text-white text-sm rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-sky-500/50"
                          autoFocus
                        />
                      ) : (
                        message.messageText && (
                            ...
                            {editingMessageId === message.id ? (
                              <>
                                <button
                                  ...
                                  className="text-xs px-2 py-0.5 hover:bg-black/20 rounded-md text-sky-300 hover:text-sky-300"
                                  title={t.save}
                                >
                                  ✓
                                </button>
        ...
        <div className="px-4 py-3 bg-black/70 backdrop-blur-md border-t border-white/15 flex-shrink-0 shadow-2xl">
          ...
          <div className="flex items-end gap-2">
            ...
            <input
              ...
              className="flex-1 bg-gray-800/95 backdrop-blur-md text-white rounded-xl px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-sky-500/50 focus:border-sky-500/50 border border-gray-700/60 placeholder:text-white/40 transition-all duration-200"
              disabled={sending}
            />
            <button
              onClick={() => {
              ...
              className="p-2.5 bg-gradient-to-br from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 active:from-blue-700 active:to-slate-800 rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex-shrink-0 shadow-lg shadow-sky-500/30 hover:scale-105 disabled:hover:scale-100 flex items-center justify-center"
            >
