      ...
      <div className="text-center space-y-3">
        <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3">
          <div className="flex items-center justify-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-br from-sky-400 to-blue-500 rounded-full flex items-center justify-center shadow-lg shadow-sky-500/30">
        ...
        <div className="px-4 overflow-x-auto -mx-4 scrollbar-hide">
          <div className="flex justify-center gap-3 min-w-max px-4 pb-3">
            <button
              onClick={() => setFilter('all')}
              className={`px-5 py-2.5 rounded-full text-base font-semibold transition-colors flex items-center gap-2 whitespace-nowrap shrink-0 ${
                filter === 'all'
                  ? 'bg-gradient-to-r from-sky-400 to-blue-500 text-black'
                ...
                <div className="flex justify-between items-start">
                      ...
                      <div className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center flex-shrink-0">
                        {bankIcon && bankIcon.image ? (
                          ...
                          <div className={`w-2.5 h-2.5 rounded-full ${
                            transaction.type === 'deposit' ? 'bg-sky-400' : 'bg-red-400'
                          }`}></div>
                        )}
                      </div>
                  ...
                  <div className="text-right space-y-1 ml-4">
                    <div className={`font-bold text-lg ${
                      transaction.type === 'deposit' ? 'text-sky-300' : 'text-red-400'
                    }`}>
                    ...
                    <div className={`text-xs font-medium px-2 py-1 rounded-full inline-block ${
                      (() => {
                        ...
                        const bgColor = color.replace('text-sky-300', 'bg-sky-500/20').replace('text-yellow-400', 'bg-yellow-500/20').replace('text-red-400', 'bg-red-500/20').replace('text-white/60', 'bg-gray-500/20')
