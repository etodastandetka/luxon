...
export function middleware(request: NextRequest) {
  ...
  const publicApiRoutes = ['/api/auth', '/api/payment', '/api/transaction-history', '/api/public', '/api/withdraw-check', '/api/withdraw-check-exists', '/api/incoming-payment', '/api/referral/register', '/api/users', '/api/crypto-pay', '/api/requests']
