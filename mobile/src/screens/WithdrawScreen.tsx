...
export default function WithdrawScreen() {
  ...
  const handleStart = () => {
    Alert.alert('Вывод', `Сумма: ${amount} • Метод: ${method}\nРеквизиты: ${details || '—'}\n(Подключим API)`)
  }

  return (
    <View style={styles.screen}>
      <Text style={styles.title}>Вывод средств</Text>
      <Text style={styles.text}>Введите сумму, выберите метод и укажите реквизиты.</Text>
      ...
      <TextInput
        ...
        placeholder="Номер карты / кошелька / комментарий"
        placeholderTextColor={colors.muted}
        multiline
      />
