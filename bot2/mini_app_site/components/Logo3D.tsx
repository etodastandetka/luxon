          ...
          (gltf: any) => {
            ...
            object.traverse((child: any) => {
              if (child.isMesh) {
                ...
                // Попробуем разные пороговые значения, так как модель может быть по-разному ориентирована
                // Если все белое, значит условие не срабатывает - попробуем инвертировать или изменить порог
                const isON = relativeX > 0.1 || relativeX < -0.1 // Более широкое условие
                
                // Альтернативный подход: красим в зеленый если позиция правее определенного порога
                // Попробуем красить все что справа от -0.3 (ON обычно находится справа)
                const isON2 = relativeX > -0.3
