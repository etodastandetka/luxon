<?php
/**
 * Простой PHP API для сохранения платежей в PostgreSQL
 * Просто загрузите этот файл на ваш сервер (например, в /api/payments.php)
 * 
...
try {
    ...
    // Правильно обрабатываем NULL значения (JSON null или пустая строка)
    ...
    // Форматируем дату для PostgreSQL (принимает 'YYYY-MM-DD HH:MM:SS' или ISO 8601)
